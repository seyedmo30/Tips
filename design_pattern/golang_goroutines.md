...
Concurrency یعنی "**مدیریت چند کار به طور هم‌زمان**" و Parallelism یعنی "**اجرای چند کار به طور هم‌زمان**". در Go ما با goroutineها concurrency داریم، و اگر روی چند core اجرا بشن، parallelism هم به دست میاد.
